    ...
    public static void removeGraph()
    {
    	for(int i=1;i<=size;i++)
        {
        	for(int j=1;j<=size;j++)
        	{
				...
				//since a dataMule from one group might traverse at most one node from the other group.
                //uncomment the following to use it or use the usual
        		...
        		//removing all other edges between visited nodes in a particular group
                //this helps preventing redundant nodes among groupss
